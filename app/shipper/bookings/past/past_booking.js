 ...
 */
angular.module('carrus').controller('past_booking',['$rootScope','$scope','CONSTANT','$cookies','$timeout', '$cookieStore','$http', '$state','$window','$location', function($rootScope,$scope,CONSTANT,$cookies,$timeout, $cookieStore,$http,$state,$window,$location) {

    console.log("past_booking controller called ");
    $scope.list_length=0;
    ...
    var get_upcoming = function ()
    {
        ...
        $http({
            method: 'GET',
            url: CONSTANT.apiURL +'api/v1/fleetOwner/getPast',
            headers: {
